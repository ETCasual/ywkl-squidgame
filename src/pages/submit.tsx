  ...
  return (
    <div className="min-h-screen bg-gray-900 px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md space-y-6">
        ...
        {/* Separate Reset Number Form */}
        <div className="rounded-lg bg-yellow-900/20 p-6 shadow-xl">
          <h2 className="mb-6 flex items-center gap-2 text-center text-xl font-bold text-yellow-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
